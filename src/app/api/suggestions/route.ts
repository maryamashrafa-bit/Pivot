...
function buildPrompt(title: string, optA: string, optB: string, context: string) {
  return [
    ...
    '',
    'STEP 2 — Classify the decision into exactly one category, judged from what it is actually about, not surface keywords: career, relocation, relationship, family, lifestyle, financial, health, education, or other. "Should I take the promotion or stay home with the baby" is a family decision wearing career clothing — classify by substance. The same applies to relocation: moving to a new city or area is a RELOCATION decision even when a job offer or family reasons are what triggered it — classify by what is actually being decided (where to live), because relocation carries its own distinct set of factors that a career or family lens would miss.',
    '',
    ...
    '',
    'THE CALIBRATION BAR — relocation decisions set the standard every category must hit. Genuinely useful relocation factors look like this: weather and climate, quality of schools, cost of living, business and career climate, tax environment, safety and crime rates, entertainment and social scene, proximity to family. Notice what makes these good: they are specific, practical, and immediately scoreable — a person reads one and instantly knows what they are scoring and why it matters, with no further explanation needed. Hold every suggestion in every category to this exact bar, whether the decision is about career, family, health, or anything else. A vague, abstract, or ambiguous factor has failed this bar regardless of which category it belongs to.',
    '',
    ...
    '  RELOCATION (moving city, moving country, choosing where to live — regardless of what triggered it): weather and climate, quality of local schools, cost of living, local business and career climate, tax environment, safety and crime rates, entertainment and social scene, proximity to family and friends — as well as housing costs, commute and transport links, healthcare access, and what it costs emotionally to leave an existing community behind.',
    ...
    '  LIFESTYLE (a life change that is not a relocation — retiring, downsizing, a big purchase, a new pursuit): values alignment, social connections and community, sense of belonging, practical adaptation to the change, financial implications, identity shift.',
